...
from _kv import KVNotConfigured, get as kv_get
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self) -> None:
        ...
        if stored and stored == _hash(password):
            return self._respond(200, {"message": "Login Successful"})
        return self._respond(401, {"message": "Login Failed"})
