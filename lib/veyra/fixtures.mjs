...
/** Demo autopilot policy: disabled, but with destinations already approved so
 *  the activation flow is exercisable. Enabling still requires all four
 *  acknowledgements from a person. */
export const demoAutopilot = {
  ...
  allowedDestinations: ['fidelity_brokerage', 'ally_savings'],
  activatedAt: null,
  consentVersion: null,
};
